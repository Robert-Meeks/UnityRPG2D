...
namespace UnityStandardAssets.Utility
{
    public class ParticleSystemDestroyer : MonoBehaviour
    {
        ...
        private IEnumerator Start()
        {
            ...
            {
                // first arg in tutorial is "system.startLifetime" this is now obsolete for good explanation see: https://stackoverflow.com/questions/41393814/unity-5-5-obsolete-particle-system-code
